...
kubectl delete -f grouper-ws-claim0-persistentvolumeclaim.yaml
kubectl delete -f grouper-ws-claim1-persistentvolumeclaim.yaml
kubectl delete -f grouper-ws-claim2-persistentvolumeclaim.yaml
